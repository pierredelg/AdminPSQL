...
@WebServlet("/servlet-Select2")
public class Select2 extends HttpServlet {

    public void doGet(HttpServletRequest req, HttpServletResponse res ) {

        System.out.println("SERVLET SELECT2 GET");
        ...
        try{
            ...
            while(rs != null && rs.next()){
                ...
                if(updateOk) {
                    ...
                    System.out.println("<input type=\"hidden\" id=\"table\" name=\"table\" value=\"" + table + "\"/>");
                    ...
                    out.println("</form>");
                    /*BOUTON ANNULER*/
                    out.println("<form action=\""+ contextPath +"/servlet-Select2\" method=\"get\">" );
                    out.println(  "<input type=\"hidden\" id=\"table\" name=\"table\" value=\"" + table + "\"/>");
